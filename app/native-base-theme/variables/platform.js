...
export default {
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? '#F8F8F8' : '#007aff',
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#007aff',
  segmentBorderColor: platform === PLATFORM.IOS ? '#007aff' : '#007aff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : '#007aff',
